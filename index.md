...
- [Before you begin](#before-you-begin)
 ...
 - [Configuration Overview](#configuration-overview)
    - [Configure the Alibaba Cloud VPC, VSwitch, and VPN Gateway](#configure-the-alibaba-cloud-vpc-vswitch-and-vpn-gateway)
    - [Configure the GCP side](#configure-the-gcp-side)
    - [Configure the Alibaba Cloud Customer Gateway and IPSec Connection](#configure-the-alibaba-cloud-customer-gateway-and-ipsec-connection)
 - [Configure the GCP side](#configure-the-gcp-side)
